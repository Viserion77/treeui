...
const listboxId = createId('t-combobox');
...
<template>
  ...
  >
    <div class="t-combobox__control">
      <span
        v-if="$slots.prefix"
        class="t-combobox__slot t-combobox__slot--prefix"
      >
        <slot name="prefix" />
      </span>
      <input
        v-bind="inputAttrs"
        class="t-combobox__input"
        role="combobox"
        type="text"
        :value="query"
    ...
    <transition name="t-fade">
      <ul
        ...
        :id="listboxId"
        role="listbox"
        class="t-combobox__listbox"
        :aria-label="listboxLabel"
        :aria-labelledby="listboxLabelledby"
      >
        <li
          v-if="filteredOptions.length === 0"
          class="t-combobox__empty"
        >
          <slot
            name="empty"
            :query="query"
            ...
            >
              <span class="t-combobox__option-copy">
                ...
                <span
                  ...
                  class="t-combobox__option-description"
                >
                  {{ option.description }}
                </span>
              </span>

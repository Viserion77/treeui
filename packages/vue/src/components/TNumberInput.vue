...
<template>
  ...
  >
    <button
      v-if="controls"
      type="button"
      class="t-number-input__stepper t-number-input__stepper--decrement"
    ...
    <button
      v-if="controls"
      type="button"
      class="t-number-input__stepper t-number-input__stepper--increment"

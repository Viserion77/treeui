...
export interface TToggleGroupOption {
  label: string;
  value: string;
  disabled?: boolean;
}
...
const props = withDefaults(
  defineProps<{
    ...
    options?: TToggleGroupOption[];
    selectionMode?: TToggleGroupSelectionMode;
    size?: TSize;
...
defineSlots<{
  option?: (props: { option: TToggleGroupOption; selected: boolean }) => unknown;
}>();
...
const rootClasses = computed(() => [
  ...
  `t-toggle-group--${props.selectionMode}`,
  {

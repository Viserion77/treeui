...
import TTreeViewItem from './TTreeViewItem.vue';
import {
...
const baseId = createId('t-tree-view');
...
const flattenNodes = (
  ...
  nodes.reduce<TTreeViewRecord[]>((records, node) => {
    records.push({
      node,
      level,
      parentId,
